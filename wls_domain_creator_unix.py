#/opt/oracle/wlshome/oracle_common/common/bin/wlst.sh /opt/oracle/wls_domain_creator_unix.py
import os
import sys
import time
import fileinput
...
def nm_modify():
    ...
    global NMProps
    global NMConfF
    NMProps = domainroot+'/'+domainNameF+"/nodemanager/nodemanager.properties"
    NMConfF = domainroot+'/'+domainNameF+"/config/nodemanager/nm_password.properties"
    #NM Credentials
